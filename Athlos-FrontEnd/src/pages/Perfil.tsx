...
const PerfilUsuario = () => {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("athlos_usuario");
    localStorage.removeItem("athlos_datos");
    localStorage.removeItem("athlos_entorno");
    localStorage.removeItem("athlos_chat_history");
    localStorage.removeItem("athlos_idusuario");
    navigate("/");
  };
